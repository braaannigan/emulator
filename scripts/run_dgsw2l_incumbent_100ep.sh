...
EXPERIMENT_ID="${1:-$(date -u +%Y%m%dT%H%M%S)-dgsw2l-incumbent-objB1-100ep}"
CONFIG_PATH="config/emulator/unet_thickness_shifting_wind_2layer_incumbent_objB1_residual_ss005_100ep_manual.yaml"

echo "Running incumbent 100-epoch experiment"
