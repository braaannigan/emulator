...
MANIFEST="${1:-boundary_bias_hypothesis_manifest.csv}"
RUN_PREFIX="${2:-$(date -u +%Y%m%dT%H%M%S)-dgsw2l-bbias}"
RETURN_BRANCH="${3:-2026-04-24-dgsw2l-boundary-bias-setup}"
...
echo "Completed boundary-bias branch sequence."
