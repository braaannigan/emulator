...
MANIFEST="${1:-graph_hypothesis_manifest.csv}"
RUN_PREFIX="${2:-$(date -u +%Y%m%dT%H%M%S)-dgsw2l-graph}"
RETURN_BRANCH="${3:-2026-04-24-dgsw2l-graph-setup}"
...
echo "Completed graph branch sequence."
