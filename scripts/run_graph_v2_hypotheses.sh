...
MANIFEST="${1:-graph_v2_hypothesis_manifest.csv}"
RUN_PREFIX="${2:-$(date -u +%Y%m%dT%H%M%S)-dgsw2l-graphv2}"
RETURN_BRANCH="${3:-2026-04-26-dgsw2l-graphv2-setup}"
...
echo "Completed graph-v2 branch sequence."
