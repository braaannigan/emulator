...
MANIFEST="${1:-spectral_damping_hypothesis_manifest.csv}"
RUN_PREFIX="${2:-$(date -u +%Y%m%dT%H%M%S)-dgsw2l-specdamp}"
RETURN_BRANCH="${3:-2026-04-24-dgsw2l-spectral-damping-setup}"
...
echo "Completed spectral-damping branch sequence."
