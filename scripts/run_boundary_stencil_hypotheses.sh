...
MANIFEST="${1:-boundary_stencil_hypothesis_manifest.csv}"
RUN_PREFIX="${2:-$(date -u +%Y%m%dT%H%M%S)-dgsw2l-bstencil}"
RETURN_BRANCH="${3:-2026-04-23-dgsw2l-boundary-stencil-setup}"
...
echo "Completed boundary-stencil branch sequence."
